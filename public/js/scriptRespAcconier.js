...
function renderAgentTableRows(deliveries, tableBodyElement) {
  ...
  deliveries.forEach((delivery, i) => {
    ...
    // Ajout de l'icône de suppression (cachée par défaut)
    const deleteBtn = document.createElement("button");
    deleteBtn.innerHTML = '<i class="fas fa-trash-alt"></i>';
    deleteBtn.title = "Supprimer cette livraison";
    ...
    deleteBtn.style.boxShadow = "0 2px 8px #dc262622";
    deleteBtn.style.zIndex = 10;
    // Gestion du survol de la ligne pour afficher/cacher le bouton
    tr.addEventListener("mouseenter", function () {
      deleteBtn.style.display = "block";
      tr.style.background = "#fef2f2"; // léger fond rouge clair au survol
    });
    ...
    deleteBtn.addEventListener("click", function (e) {
      ...
      overlay.style.background = "rgba(30,41,59,0.32)";
      ...
      msg.innerHTML =
        '<i class="fas fa-exclamation-triangle" style="color:#dc2626;font-size:2em;margin-bottom:10px;"></i><br><span style="font-size:1.15em;font-weight:600;color:#0e274e;">Voulez-vous vraiment supprimer cette livraison ?</span>';
      box.appendChild(msg);
      const btns = document.createElement("div");
      btns.style.display = "flex";
      btns.style.gap = "18px";
      btns.style.marginTop = "22px";
      const yesBtn = document.createElement("button");
      yesBtn.textContent = "Oui, supprimer";
      ...
      yesBtn.onclick = async function () {
        ...
        try {
          const res = await fetch(`/deliveries/${delivery.id}`, {
            method: "DELETE",
          });
    ...
    // Pour positionner le bouton à droite de la ligne
    tr.style.position = "relative";
    // Ajout du bouton à la ligne (hors des cellules)
